...
<%
    ...
    boolean tieneEntrada = asistencia.horaEntrada != null;
    boolean tieneSalida = asistencia.horaSalida != null;
%>
<html>
    <head>
                                ...
                                <div class="card shadow-lg rounded-4 ">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <!-- Simulación de celulares -->
                                            <div class="col-md-9 d-flex justify-content-center flex-wrap " style="gap: 3rem;">

                                                <!-- iPhone Entrada -->
                                                <div class="bg-dark p-2 rounded-4 mb-4" style="width: 360px; border: 14px solid #000; border-radius: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
                                                    <div class="bg-white rounded-4 overflow-hidden" style="height: 600px;">
                                                        ...
                                                        <div class="p-4">
                                                            ...
                                                            <p class="mb-4"><i class="bi bi-clock me-2"></i><strong>Hora:</strong> <%= tieneEntrada ? asistencia.horaEntrada : "No registrada"%></p>
                                                ...
                                                <!-- iPhone Salida -->
                                                <div class="bg-dark p-2 rounded-4 mb-4" style="width: 360px; border: 14px solid #000; border-radius: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); opacity: <%= tieneEntrada ? "1" : "0.5"%>;">
                                                    <div class="bg-white rounded-4 overflow-hidden" style="height: 600px;">
                                                        <div class="bg-dark text-white text-center py-2">
                                                        ...
                                                        <div class="p-4">
                                                            ...
                                                            <p class="mb-2"><i class="bi bi-calendar-date-fill me-2"></i><strong>Fecha:</strong> <%= fechaHoy%></p>
                                                            <p class="mb-4"><i class="bi bi-clock-history me-2"></i><strong>Hora:</strong> <%= tieneSalida ? asistencia.horaSalida : "No registrada"%></p>
