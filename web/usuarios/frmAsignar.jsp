                                ...
                                <div class="modal fade" id="modalAsignar<%= id%>" tabindex="-1" aria-labelledby="modalLabel<%= id%>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="TicketsController" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="idTecnicos" required>
                                                            ...
                                                            <%
                                                                ArrayList<TecnicoBE> listaTecnicoBE = (ArrayList<TecnicoBE>) request.getAttribute("listaTecnicoBE");
                                                                if (listaTecnicoBE != null) {
                                                                    for (TecnicoBE tecnico : listaTecnicoBE) {
                                                            %>
                                                            <option value="<%= tecnico.getIdTecnico()%>">
                                                                <%= tecnico.getUsuario().getNombre()%> - <%= tecnico.getEspecialidad()%>
                                                            </option>
                                                            <%
                                                                }
                                                            } else {
